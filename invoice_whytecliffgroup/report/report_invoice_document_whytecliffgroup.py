...
class account_invoice_whytecliffgroup(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context=None):
        super(account_invoice_whytecliffgroup, self).__init__(cr, uid, name, context=context)
...
class report_accountinvoice(osv.AbstractModel):
    ...
    _wrapped_report_class = account_invoice_whytecliffgroup
